...
class IncrementalKVIngest:
    ...
    def __init__(self) -> None:
        ...
        try:
            ...
            pprint.print(Platform.SYSTEM, Status.ERR, "cloudflare_kv module not found")
            raise
        ...
        try:
            ...
            pprint.print(
                Platform.SYSTEM, Status.PASS, "Connected to Cloudflare Workers KV"
            )
        except Exception as e:
            pprint.print(
                Platform.SYSTEM,
                Status.ERR,
                f"Failed to connect to Cloudflare Workers KV: {e}",
            )
            raise
    ...
    def prune_all_keys(self) -> None:
        ...
        try:
            ...
            pprint.print(
                Platform.SYSTEM, Status.ERR, f"Error pruning Cloudflare KV: {e}"
            )
            raise
