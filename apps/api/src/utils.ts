...
import { isValidTarget, resolvePlatform } from "@repo/platform-data";
import { ROUTE_PATHS } from "./config";
import type { AnimeData, ErrorResponse, QueryParams } from "./types";

// Re-export shared functions
export { resolvePlatform, isValidTarget };
